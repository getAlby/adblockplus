console.log("WebLN injected");
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ? t(exports, require("events"), require("nostr-tools"))
    : "function" == typeof define && define.amd
    ? define(["exports", "events", "nostr-tools"], t)
    : t(((e || self).sdk = {}), e.events, e.nostrTools);
})(this, function (e, t, n) {
  function r(e) {
  ...
  var q = /*#__PURE__*/ (function () {
      function e(e) {
        (this.token = void 0),
          ...
          (this._tokenEvents = void 0),
          (this._tokenEvents = new o.default());
        var t = e.token,
          n = f(e, E);
                      ...
                      (function (r, o) {
                        try {
                          var i = (function (n, r) {
                            ...
                            console.error(t),
                              n(t),
                              e._tokenEvents.emit("tokenRefreshFailed", t);
                          });
                        } catch (e) {
                          return o(!0, e);
                        }
          ...
          try {
            ...
            return Promise.resolve(
              R(
                ...
                function (e) {
                  throw (
                    (console.error("Failed to request lookup_invoice", e), e)
                  );
                }
              )
            );
      ...
      return (
        ...
        (t.getInfo = function () {
          try {
            ...
            return Promise.resolve(e.checkEnabled()).then(function () {
              ...
              return (function (r, o) {
                try {
                  var i = Promise.resolve(e.client.getInfo()).then(function (
                    r
                  ) {
                    var o = {
        ...
        (t.listTransactions = function (e) {
          try {
            var t = this;
            return Promise.resolve(t.checkEnabled()).then(function () {
              return Promise.resolve(t.client.listTransactions(e)).then(
                function (e) {
  ...
  (e.Client = K), (e.auth = O), (e.nwc = x), (e.types = y), (e.webln = B);
  window.webln = B;
});
